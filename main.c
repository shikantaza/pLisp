...
OBJECT_PTR HALT     = (OBJECT_PTR)((82 << OBJECT_SHIFT) + SYMBOL_TAG);                  
OBJECT_PTR REFER    = (OBJECT_PTR)((83 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR CONSTANT = (OBJECT_PTR)((84 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR CLOSE    = (OBJECT_PTR)((85 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR TEST     = (OBJECT_PTR)((86 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR ASSIGN   = (OBJECT_PTR)((87 << OBJECT_SHIFT) + SYMBOL_TAG);         
OBJECT_PTR CONTI    = (OBJECT_PTR)((88 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR NUATE    = (OBJECT_PTR)((89 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR FRAME    = (OBJECT_PTR)((90 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR ARGUMENT = (OBJECT_PTR)((91 << OBJECT_SHIFT) + SYMBOL_TAG);
...
OBJECT_PTR MACRO    = (OBJECT_PTR)((92 << OBJECT_SHIFT) + SYMBOL_TAG);
/* end symbols corresponding to assembler mnemonics */

/* symbols useful in FFI */
OBJECT_PTR INTEGR        = (OBJECT_PTR)((93 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR FLOT          = (OBJECT_PTR)((94 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR CHAR          = (OBJECT_PTR)((95 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR VOID          = (OBJECT_PTR)((96 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR INT_POINTER   = (OBJECT_PTR)((97 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR FLOAT_POINTER = (OBJECT_PTR)((98 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR CHAR_POINTER  = (OBJECT_PTR)((99 << OBJECT_SHIFT) + SYMBOL_TAG);
/* end symbols useful in FFI */

OBJECT_PTR LET           = (OBJECT_PTR)((100 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR COND          = (OBJECT_PTR)((101 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR DOTIMES       = (OBJECT_PTR)((102 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR DOLIST        = (OBJECT_PTR)((103 << OBJECT_SHIFT) + SYMBOL_TAG);

OBJECT_PTR LET1          = (OBJECT_PTR)((104 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR DEFUN         = (OBJECT_PTR)((105 << OBJECT_SHIFT) + SYMBOL_TAG);
OBJECT_PTR DEFMACRO      = (OBJECT_PTR)((106 << OBJECT_SHIFT) + SYMBOL_TAG);
...
void initialize_core_package()
{
  ...
  /* symbols corresponding to assembler mnemonics */
  packages[CORE_PACKAGE_INDEX].symbols[82] =  strdup("HALT");
  packages[CORE_PACKAGE_INDEX].symbols[83] =  strdup("REFER");
  packages[CORE_PACKAGE_INDEX].symbols[84] =  strdup("CONSTANT");
  packages[CORE_PACKAGE_INDEX].symbols[85] =  strdup("CLOSE");
  packages[CORE_PACKAGE_INDEX].symbols[86] =  strdup("TEST");
  packages[CORE_PACKAGE_INDEX].symbols[87] =  strdup("ASSIGN");         
  packages[CORE_PACKAGE_INDEX].symbols[88] =  strdup("CONTI");
  packages[CORE_PACKAGE_INDEX].symbols[89] =  strdup("NUATE");
  packages[CORE_PACKAGE_INDEX].symbols[90] =  strdup("FRAME");
  packages[CORE_PACKAGE_INDEX].symbols[91] =  strdup("ARGUMENT");
  /* APPLY already defined as a special symbol */
  /* RETURN already defined as a special symbol */
  /* DEFINE already defined as a special symbol */
  packages[CORE_PACKAGE_INDEX].symbols[92] = strdup("MACRO");
  /* end symbols corresponding to assembler mnemonics */

  /* symbols for FFI */
  packages[CORE_PACKAGE_INDEX].symbols[93] = strdup("INTEGER");
  packages[CORE_PACKAGE_INDEX].symbols[94] = strdup("FLOAT");
  packages[CORE_PACKAGE_INDEX].symbols[95] = strdup("CHARACTER");
  packages[CORE_PACKAGE_INDEX].symbols[96] = strdup("VOID");
  packages[CORE_PACKAGE_INDEX].symbols[97] = strdup("INTEGER-POINTER");
  packages[CORE_PACKAGE_INDEX].symbols[98] = strdup("FLOAT-POINTER");
  packages[CORE_PACKAGE_INDEX].symbols[99] = strdup("CHARACTER-POINTER");
  /* end symbols for FFI */

  packages[CORE_PACKAGE_INDEX].symbols[100] = strdup("LET");
  packages[CORE_PACKAGE_INDEX].symbols[101] = strdup("COND");
  packages[CORE_PACKAGE_INDEX].symbols[102] = strdup("DOTIMES");
  packages[CORE_PACKAGE_INDEX].symbols[103] = strdup("DOLIST");

  packages[CORE_PACKAGE_INDEX].symbols[104] = strdup("LET1");
  packages[CORE_PACKAGE_INDEX].symbols[105] = strdup("DEFUN");
  packages[CORE_PACKAGE_INDEX].symbols[106] = strdup("DEFMACRO");
}
