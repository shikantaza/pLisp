...
* link:https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/clang+llvm-11.0.0-x86_64-linux-gnu-ubuntu-20.04.tar.xz[LLVM/Clang] (pLisp has been ported to use LLVM 11.0.0; may not compile with earlier versions of LLVM)
